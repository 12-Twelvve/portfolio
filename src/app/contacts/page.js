  ...
  return (
    ...
    <div className="gap-5 flex max-md:flex-col  md:flex-row lg:flex-row xl:flex-row  max-md:gap-0">
        ...
        <div className="flex flex-col max-md:max-w-full">
          ...
          <div className="bg-cover flex flex-col rounded-3xl md:flex-row mt-5 pl-7 pr-7 pt-1 pb-1 gap-5  min-h-[45vh] max-h-[45vh] max-md:min-h-[50vh] max-md:max-h-[50vh]"
            ...
            <div className="w-full text-center sm:p-8">
                <p className="text-base text-white sm:text-lg ">Kathmandu, Nepal  </p>
                <p className="text-base text-white sm:text-lg ">+977-9863658976</p>
      ...
      <div className="bg-cover max-sm:h-[60vh] w-full md:w-2/5 mt-5 pt-6 rounded-3xl "
        ...
        {/* form */}
        <form onSubmit={handleSubmit} className=" max-w-sm max-sm:ps-10 mx-auto mt-10 flex flex-col gap-7">
        <div className="relative block">
          ...
          <input type="text" id="person_name" name="name" value={formData.name} onChange={handleChange}
            className="block w-[85%] max-sm:w-[70%] ps-10 p-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  dark:bg-bggrayarc dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
        ...
        <textarea id="message" name="message" value={formData.message} onChange={handleChange} rows="4" 
          className="block w-[85%] max-sm:w-[70%] p-3 pr-10  text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-bggrayarc dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
